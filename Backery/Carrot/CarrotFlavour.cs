...
{
    public class CarrotFlavour : CustomItem
    {
        public override string UniqueNameID => "Carrot Flavour";
        public override GameObject Prefab => getPrefab(GetGDO<Item>(ItemReferences.CarrotChopped));
        ...
        public override void OnRegister(Item gdo)
        {
            ...
            {
                GetGDO<Item>(ItemReferences.CarrotChopped)
            };
        }
    }
}