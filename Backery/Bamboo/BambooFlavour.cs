...
{
    public class BambooFlavour : CustomItem
    {
        public override string UniqueNameID => "Bamboo Flavour";
        public override GameObject Prefab => getPrefab(GetGDO<Item>(ItemReferences.BambooCooked));
        ...
        public override void OnRegister(Item gdo)
        {
            ...
            {
                GetGDO<Item>(ItemReferences.BambooCooked)
            };
        }
    }
}