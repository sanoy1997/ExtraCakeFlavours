...
{
    public class MeatFlavour : CustomItem
    {
        public override string UniqueNameID => "Meat Flavour";
        public override GameObject Prefab => getPrefab(GetGDO<Item>(ItemReferences.MeatChopped));
        public override string ColourBlindTag => "Me";
