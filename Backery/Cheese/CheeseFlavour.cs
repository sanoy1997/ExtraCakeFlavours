...
{
    public class CheeseFlavour : CustomItem
    {
        public override string UniqueNameID => "Cheese Flavour";
        public override GameObject Prefab => getPrefab(GetGDO<Item>(ItemReferences.CheeseGrated));
        public override string ColourBlindTag => "Chee";
