...
{
    public class MayoFlavour : CustomItem
    {
        public override string UniqueNameID => "Mayo Flavour";
        public override GameObject Prefab => getPrefab(GetGDO<Item>(ItemReferences.Mayonnaise));
