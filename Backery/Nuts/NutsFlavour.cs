...
{
    public class NutsFlavour : CustomItem
    {
        public override string UniqueNameID => "Nuts Flavour";
        public override GameObject Prefab => getPrefab(GetGDO<Item>(ItemReferences.NutsChopped));
