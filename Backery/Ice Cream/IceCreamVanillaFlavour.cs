...
{
    public class IceCreamVanillaFlavour : CustomItem
    {
        public override string UniqueNameID => "Ice Cream Vanilla Flavour";
        public override GameObject Prefab => getPrefab(GetGDO<Item>(ItemReferences.IceCreamVanilla));
        public override string ColourBlindTag => "IC-V";
